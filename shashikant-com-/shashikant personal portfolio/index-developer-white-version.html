            ...
            <div class="menu-top">
                <div class="menu-header">
                    <a class="logo" href="index.html">
                        <img src="assets/images/logo/logos-circle.png" width="35%"  alt="Personal Portfolio">
                    </a>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-12">
                                        <div class="user-info-top">
                                            <div class="user-info-header">
                                                ...
                                                <h2 class="title">
                                                    Hi, I’m <span>shashikant</span>
                                                </h2>
                                                <p class="disc">I will help you build your brand and grow your business. I create clarifying strategy, beautiful logo and identity design and engaging websites. in Nepal,
                                                    Birgunj.</p>
                                            </div>
                                            <div class="user-info-footer">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <span>shashikantshah540@gmail.com</span>
                                                </div>
                                                <div class="info">
                                                    <i data-feather="map-pin"></i>
                                                    <span>Nepal,Birgunj</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-12">
                                        <div class="user-info-bottom">
                                            ...
                                            <div class="button-wrapper d-flex">
                                                <a class="rn-btn mr--30" href="./index.html"><span>DOWNLOAD CV</span></a>
                                                <a class="rn-btn" href="./index.html"><span>CONTACT ME</span></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <h4 class="title"><a href="javascript:void(0)">Mobile app landing design & Services<i
                                                        class="feather-arrow-up-right"></i></a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <h4 class="title"><a href="javascript:void(0)">Web app Responsive design & Services<i
                                                        class="feather-arrow-up-right"></i></a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <h4 class="title"><a href="javascript:void(0)">PHP with app landing design & Services<i
                                                        class="feather-arrow-up-right"></i></a></h4>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-12 col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="logo-thumbnail">
                        <a href="#"><img src="assets/images/logo/logo-dark.png"  width="150px" alt="logo-image"></a>
                    </div>
