            ...
            <div class="header-wrapper m--0 rn-popup-mobile-menu row align-items-center">
                ...
                <div class="col-lg-2 col-6">
                    <div class="header-left">
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/images/logo/logo-dark.png" width="60px" alt="logo">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="menu-top">
                    <div class="menu-header">
                        <a class="logo" href="index.html">
                            <img src="assets/images/logo/logo-dark.png" width="35%" alt="Personal Portfolio">
                        </a>
                        ...
                        <div class="order-2 order-lg-1 col-lg-9 col-xl-7">
                            <div class="content">
                                <div class="inner fashion-designer-inner mb--60 text-left  mb_sm--80">
                                    ...
                                    <p class="disc fd-lorem">Nepal fashion designer and Entrepreneur</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="inner">
                                    <div class="card-info">
                                        <div class="card-thumbnail">
                                            <img src="assets/images/slider/shashikant.jpg" alt="Testimonial-image">
                                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="contact-about-area">
                            ...
                            <div class="title-area">
                                ...
                                <span>Freelancer developer & Designer</span>
                            </div>
            ...
            <div class="wrapper">
                ...
                <div class="rn-modal-inner">
                    <div class="demo-top text-center">
                        <h4 class="title">shashikant</h4>
                        <p class="subtitle">this is all personal portfolio template by me. You can buy it.</p>
                    </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-12 col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="logo-thumbnail">
                        <a href="#"><img src="assets/images/logo/logo-dark.png" width="60%" alt="logo-image"></a>
                    </div>
