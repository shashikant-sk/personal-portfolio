...
<body class="template-color-1 box-wrapper spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
    <!-- Start Header -->
        ...
        <div class="header-wrapper rn-popup-mobile-menu m--0 row align-items-center">
            ...
            <div class="col-lg-2 col-6">
                <div class="header-left">
                    <div class="logo">
                        <a href="index.html">
                            <img src="assets/images/logo/logo.png" width="40%" alt="logo">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-10 col-6">
                <div class="header-center">
                    ...
                    <div class="header-right">
                        <a class="rn-btn" target="_blank" href="./index.html"><span>BUY NOW</span></a>
            ...
            <div class="menu-top">
                <div class="menu-header">
                    <a class="logo" href="index.html">
                        <img src="assets/images/logo/logo.png" width="30%" alt="Personal Portfolio">
                    </a>
                    <div class="close-button">
                        <button class="close-menu-activation close"><i data-feather="x"></i></button>
                    </div>
                </div>
                <p class="discription">this is all personal portfolio template by Me. You can buy it.
                </p>
            </div>
            <div class="content">
                <ul class="primary-menu nav nav-pills">
                ...
                <div class="social-share-style-1 mt--40">
                    ...
                    <ul class="social-share d-flex liststyle">
                        <li class="facebook"><a href="https://facebook.com/passion.for.goal/"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook">
                                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                                </svg></a>
                        </li>
                        <li class="instagram"><a href="https://instagram.com/shashikant_001"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram">
                                    <rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
                                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path>
                                    <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line>
                                </svg></a>
                        </li>
                        <li class="linkedin"><a href="https://linkedin.com/in/shashikant-001"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-linkedin">
    ...
    <main class="main-page-wrapper">
        ...
        <div id="home" class="rn-slider-area">
            <div class="slide slider-style-1 box-layout">
                <div class="container">
                    <div class="row row--30 align-items-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12">
                                        <div class="social-share-inner-left">
                                            <span class="title">find with me</span>
                                            <ul class="social-share d-flex liststyle">
                                                <li class="facebook"><a href="https://facebook.com/passion.for.goal"><i data-feather="facebook"></i></a>
                                                </li>
                                                <li class="instagram"><a href="https://instagram.com/shashikant_001/"><i data-feather="instagram"></i></a>
                                                </li>
                                                <li class="linkedin"><a href="https://linkedin.com/in/shashikant-001"><i data-feather="linkedin"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="order-1 order-lg-2 col-lg-5">
                            <div class="thumbnail box-gradient">
                                <div class="inner">
                                    <img class="w-100" src="assets/images/slider/shashikant.jpg"  alt="Personal Portfolio Images">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">
                        ...
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/images/logo/logo-vertical.png" width="100%" alt="logo">
                            </a>
                        </div>
