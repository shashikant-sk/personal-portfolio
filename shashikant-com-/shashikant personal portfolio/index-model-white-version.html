...
<body class="white-version home-classic spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
    ...
    <main class="main-page-wrapper spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
            ...
            <div class="header-wrapper m--0 rn-popup-mobile-menu row align-items-center">
                ...
                <div class="col-lg-2 col-6">
                    <div class="header-left">
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/images/logo/logos-circle.png" width="60px" alt="logo">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div id="home" class="rn-slider-area">
            <!-- Start Single Slide -->
            <div class="slide slider-style-4 bg_image bg_image--12">
                <div class="container">
                    <div class="row justify-content-center text-center">
                        <div class="order-2 order-lg-1 col-lg-9 col-xl-7">
                            <div class="content">
                                <div class="inner fashion-designer-inner model mb--0 mt--180 text-center">
                                    <h1 class="title">KRISTINA SOMOLYER</h1>
                                    <p class="disc fd-lorem">Nepal Supermodel & Entrepreneur</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-image-area-fitness attachment bg_image--8 bg_image">
        ...
        <div class="rn-portfolio-area rn-section-gap" id="portfolio">
            <div class="container">
                ...
                <div class="row mt--10 mt_md--10 mt_sm--10">
                    <!-- Start Single Portfolio -->
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-6 col-md-6 col-12 mt--30 mt_md--30 mt_sm--30">
                    ...
                    <!-- Start Single Portfolio -->
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-6 col-md-6 col-12 mt--30 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                        ...
                        <div class="contact-about-area">
                            ...
                            <div class="social-area">
                                ...
                                <div class="social-icone">
                                    ...
                                    <a href="https://www.instagram.com/shashikant_001/"><i data-feather="linkedin"></i></a>
                                    <a href="https://www.linkedin.com/in/shashikant-001/"><i data-feather="instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="wrapper">
                ...
                <div class="rn-modal-inner">
                    <div class="demo-top text-center">
                        <h4 class="title">shashikant</h4>
                        <p class="subtitle">this is all my personal portfolio template by shashikant. You can buy it</p>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">
                        ...
                        <p class="description mt--30">© 2021. All rights reserved by <a target="_blank" href="./index.html">SHASHIKANT.</a></p>
                    </div>
                </div>
            </div>
        </div>
