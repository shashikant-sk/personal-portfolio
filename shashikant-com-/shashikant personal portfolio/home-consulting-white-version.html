...
<body class="white-version home-sticky spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
    ...
    <div class="d-none d-xl-block header-style-2">
        <header class="rn-header-area d-flex align-items-start flex-column left-header-style">
            <div class="logo-area">
                <a href="index.html">
                    <img src="assets/images/logo/logos-circle.png" width="135px" alt="personal-logo">
                </a>
            </div>
            ...
            <div class="menu-top">
                <div class="menu-header">
                    <a class="logo" href="index.html">
                        <img src="assets/images/logo/logos-circle.png" width="40%" alt="Personal Portfolio">
                    </a>
                    ...
                    <div class="col-lg-12">
                        <div class="banner-inner">
                            <div class="thumbnail gradient-border gradient-animation">
                                <img id="border" class="gradient-border" src="assets/images/slider/my circle image.png" alt="">
                            </div>
                            <h1>Shashikant </h1>
                            <!-- type headline start-->
                                            ...
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="index-politician-white-version.html">
                                                        ...
                                                        <span class="overlay-content">
                                                    <span class="overlay-text">shashikant <i
                                                            class="feather-external-link"></i></span>
                                                        </span>
                                                    </a>
                                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-area text-center">
                            ...
                            <p class="description mt--30">© 2022. All rights reserved by <a target="_blank" href="./index-model.html">SHASHIKANT-SHAH.</a></p>
                        </div>
                    </div>
                </div>
            </div>
