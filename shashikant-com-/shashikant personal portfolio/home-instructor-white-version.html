...
<body class="template-color-1 box-wrapper spybody white-version" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
    <!-- Start Header -->
        ...
        <div class="header-wrapper rn-popup-mobile-menu m--0 row align-items-center">
            ...
            <div class="col-lg-2 col-6">
                <div class="header-left">
                    <div class="logo">
                        <a href="index.html">
                            <img src="assets/images/logo/logo-dark.png" width="40%" alt="logo">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row row--30 align-items-center">
                        <div class="order-2 order-lg-1 col-lg-7 mt_md--50 mt_sm--50 mt_lg--30">
                            <div class="content">
                                <div class="inner">
                                    ...
                                    <h1 class="title">Hi, I’m <span>shashikant</span><br><span class="span">
                                            Teacher.</span></h1>
                                    <div>
                        ...
                        <div class="order-1 order-lg-2 col-lg-5">
                            <div class="thumbnail box-gradient">
                                <div class="inner">
                                    <img class="w-100" src="assets/images/slider/banner-05.png" alt="Personal Portfolio Images">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/images/logo/logo-vertical-dark.png" width="100%" alt="logo">
                            </a>
                        </div>
