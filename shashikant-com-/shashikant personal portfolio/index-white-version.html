        ...
        <div class="header-wrapper rn-popup-mobile-menu m--0 row align-items-center">
            ...
            <div class="col-lg-2 col-6">
                <div class="header-left">
                    <div class="logo">
                        <a href="index.html">
                            <img src="assets/images/logo/logo-dark.png" width="35%" alt="logo">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-10 col-6">
                <div class="header-center">
                    ...
                    <div class="header-right">
                        <a class="rn-btn" href="./index.html"><span>Dark</span></a>
                        ...
                        <div class="order-2 order-lg-1 col-lg-7 mt_md--50 mt_sm--50 mt_lg--30">
                            <div class="content">
                                <div class="inner">
                                    ...
                                    <div>
                                        <p class="description">I will help you build your brand and grow your business. I create clarifying strategy, beautiful logo and identity design and engaging websites. </p>
                                    </div>
                                </div>
                                <div class="row">
