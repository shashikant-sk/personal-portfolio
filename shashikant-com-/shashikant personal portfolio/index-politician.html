...
<!-- Mirrored from rainbowit.net/html/inbio/index-politician.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 12:46:17 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="template-color-1 front-end-developer spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
    <!-- Start Header -->
                                ...
                                <div class="content">
                                    <div class="inner">
                                        ...
                                        <h1 class="title">Hi, I’m <span>shashikant </span><br><span
                                                class="span"> Social Politician.</span></h1>
                                        <div>
                                            <p class="description">I use animation as a third dimension by which to
                                                simplify experiences and kuiding thro each and every interaction. I’m
                                                not adding
                                                motion just to spruce things up, but doing it in ways that.</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12 mt_mobile--30">
                                            <div class="skill-share-inner">
                                                ...
                                                <ul class="skill-share d-flex liststyle">
                                                    <li><img src="assets/images/icons/icons-01.png" alt="Icons Images">
                                                    </li>
                                                    <li><img src="assets/images/icons/icons-02.png" alt="Icons Images">
                                                    </li>
                                                    <li><img src="assets/images/icons/icons-03.png" alt="Icons Images">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner ">
                                        <div class="carousel-item inner active">
                                            <img class="d-block w-100" src="assets/images/slider/banner-07.png" alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/images/slider/shashikant.jpg" alt="Second slide">
                                        </div>
                                    </div>

                                    <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
                                        <span class="" aria-hidden="true"> <i data-feather="chevron-left"></i> </span>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                    <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
                                        <span class="" aria-hidden="true"> <i data-feather="chevron-right"></i> </span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">
                        ...
                        <p class="description mt--30">© 2022. All rights reserved by <a target="_blank" href="./index.html">SHASHIKANT-SHAH.</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from rainbowit.net/html/inbio/index-politician.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 12:46:18 GMT -->
</html>