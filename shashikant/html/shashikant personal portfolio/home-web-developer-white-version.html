...
<body class="white-version home-sticky spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
    ...
    <div class="d-none d-xl-block">
        <header class="rn-header-area d-flex align-items-start flex-column left-header-style">
            <div class="logo-area">
                <a href="index.html">
                    <img src="assets/images/logo/logos-circle.png" width="90px" alt="personal-logo">
                </a>
            </div>
        ...
        <div class="inner">
            ...
            <div class="content">
                <ul class="primary-menu nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link smoth-animation-two" href="./index.html">Contact</a></li>
                </ul>
                <!-- social sharea area -->
                    ...
                    <div class="row">
                        <div class="banner-inner text-center">
                            ...
                            <div class="button-area">
                                <a class="rn-btn shadow-none" href="./index.html"><span>CONTACT ME</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="tab-pane fade " id="test" role="tabpanel" aria-labelledby="test-tab">
                                    ...
                                    <div class="rn-pricing">
                                        ...
                                        <div class="pricing-footer">
                                            <a href="./index.html" class="rn-btn d-block">
                                                <span>ORDER NOW</span>
                        ...
                        <div class="contact-about-area">
                            ...
                            <div class="social-area">
                                ...
                                <div class="social-icone">
                                    ...
                                    <a href="https://linkedin.com/in/shashikant-001/"><i data-feather="linkedin"></i></a>
