...
<body class="template-color-1 home-classic spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
    ...
    <main class="main-page-wrapper spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
            ...
            <div class="header-wrapper m--0 rn-popup-mobile-menu row align-items-center">
                ...
                <div class="col-lg-2 col-6">
                    <div class="header-left">
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/images/logo/logo.png" width="55px" alt="logo">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-center">
                        <nav id="sideNav" class="mainmenu-nav navbar-example2">
                            ...
                            <ul class="primary-menu nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link smoth-animation" href="./index.html">Contact</a>
                                </li>
                            </ul>
                            <!-- End Mainmanu Nav -->
                        </nav>
                        ...
                        <div class="header-right">
                            <a class="rn-btn no-shadow" href="./index.html"><span>CONTACT ME</span></a>
            ...
            <div class="inner">
                <div class="menu-top">
                    <div class="menu-header">
                        <a class="logo" href="index.html">
                            <img src="assets/images/logo/logo.png" width="35%" alt="Personal Portfolio">
                        </a>
                ...
                <div class="content">
                    <ul class="primary-menu nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link smoth-animation" href="./index.html">contact</a></li>
                    </ul>
                    <!-- social sharea area -->
        ...
        <div id="home" class="rn-slider-area">
            <!-- Start Single Slide -->
            <div class="slide slider-style-4 bg_image bg_image--2">
                <div class="container">
                    <div class="row justify-content-center text-left">
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="inner  mb_sm--80 mb--0">
                                    <h1 class="title color-lightn">Welcome To My <br> Fitness Center</h1>
                                    <p class="discs color-body">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo voluptatum sequi sed odit cupiditate libero non, id eveniet? Laboriosam consequatur asperiores.</p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true" class="section-title text-left">
                            ...
                            <h2 class="title">Fitness Provide</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Fitness Plans</a></h4>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Healthy Recipes</a></h4>
                                    <p class="description">I throw myself down among the tall grass by the stream as I
                                        lie close to the earth.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">FItness Book</a></h4>
                                    <p class="description">I throw myself down among the tall grass by the stream as I
                                        lie close to the earth.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            ...
                            <div class="portfolio-single">
                                <div class="row direction">
                                    ...
                                    <div class="col-lg-7 col-xl-7">
                                        <div class="thumbnail">
                                            <img src="assets/images/portfolio/portfolio-07.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="carousel-item">
                            <div class="portfolio-single">
                                <div class="row direction">
                                    ...
                                    <div class="col-lg-7 col-xl-7">
                                        <div class="thumbnail">
                                            <img src="assets/images/portfolio/portfolio-08.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="carousel-item">
                            <div class="portfolio-single">
                                <div class="row direction">
                                    ...
                                    <div class="col-lg-7 col-xl-7">
                                        <div class="thumbnail">
                                            <img src="assets/images/portfolio/portfolio-09.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="testimonial-activation-item-3 slick-arrow-style-one mb--60" data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" data-aos-once="true">
                    ...
                    <div class="rn-testimonial">
                        <div class="testimonial-inner">
                            <div class="testimonial-header">
                                <div class="thumbnail">
                                    <img src="assets/images/logo/logos-circle.png" alt="client-image">
                                </div>
                                <h5 class="ts-header">
                                    <span class="text-color-primary">@shashikant</span> Engineer
                                </h5>
                            </div>
                            <div class="testimonial-body">
                                <p class="discription">@shashikant Ypur plaser well for your template
                                    from
                    ...
                    <div class="rn-testimonial">
                        <div class="testimonial-inner">
                            ...
                            <div class="testimonial-body">
                                <p class="discription">@shashikant Much plaser well for your template
                                    from
                    ...
                    <div class="rn-testimonial">
                        <div class="testimonial-inner">
                            ...
                            <div class="testimonial-body">
                                <p class="discription">@shashikant thank you as well for your template
                                    from
                                    <span>@Alamin_Orko </span>! The team is using it too. It'll really
                                    speed up the design and
                                    development process 🏃.
                ...
                <div class="row">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" data-aos-once="true" class="col-lg-4 col-sm-12">
                        <div class="title-area-wrapper mb_md--20 mb_sm--20">
                            <div class="section-title text-left">
                                ...
                                <h2 class="title">Fitness plane pricing</h2>
                            </div>
                            <p class="title-disc">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true" class="col-lg-4 col-md-6 col-sm-12">
                        <div class="pricing-wrapper">
                            <div class="ts-header">
                                <h6>STARTER</h6>
                                <span>4 WEEK TRAINING – 30 MIN/DAY</span>
                            </div>
                            ...
                            <div class="pricing-footer">
                                <a class="rn-btn" href="./index.html"><span>Light</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true" class="col-lg-4 col-md-6 col-sm-12">
                        <div class="pricing-wrapper-pro">
                            <div class="ts-header">
                                <h6>JOIN NOW</h6>
                                <span>4 WEEK TRAINING – 50 MIN/DAY</span>
                            </div>
                    ...
                    <div class="col-lg-5">
                        <div class="contact-about-area">
                            ...
                            <div class="description">
                                ...
                                <span class="phone">Phone: <a href="tel:01941043264">+977 9845451010</a></span>
                                <span class="mail">Email: <a href="mailto:shashikantshah540@gmail.com">shashikantshah540@gmail.com</a></span>
                            </div>
    ...
    <div id="footer" class="rn-footer-area footer-style-2 rn-section-gapTop section-separator">
            ...
            <div class="row">
                <div class="col-xl-3 col-12 col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="logo-thumbnail">
                        <a href="#"><img src="assets/images/logo/logo.png" width="170px" alt="logo-image"></a>
                    </div>
                    <div class="social-icone-wrapper">
                        <ul class="social-share d-flex liststyle">
                            <li class="facebook"><a href="https://www.facebook.com/passion.for.goal"><i data-feather="linkedin"></i></a>
                            </li>
                ...
                <div class="col-sl-3 col-12 mt_sm--20 col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="menu-wrapper">
                        ...
                        <ul class="menu-footer">
                            ...
                            <li><a href="./index.html">Pricing</a></li>
                            <li><a href="./index.html">over right</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sl-3 col-12 mt_sm--20 col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="menu-wrapper">
                        ...
                        <ul class="menu-footer">
                            ...
                            <li><a href="./index.html">Support</a></li>
                            <li><a href="./index.html">Open Source</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright text-center ptb--40 section-separator">
            <p class="description">© 2022. All rights reserved by <a target="_blank" href="./index.html">SHASHIKANT.</a></p>
        </div>
    </div>
    <!-- Rn footer area end -->
    <!-- JS ============================================ -->
