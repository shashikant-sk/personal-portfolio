            ...
            <div class="header-wrapper m--0 rn-popup-mobile-menu row align-items-center">
                ...
                <div class="col-lg-2 col-6">
                    <div class="header-left">
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/images/logo/logo.png" width="40px"alt="logo">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-10 col-6">
                    <div class="header-center">
                        ...
                        <div class="header-right">
                            <a class="rn-btn no-shadow btn-theme" href="./index.html"><span>BUY NOW</span></a>
                ...
                <div class="menu-top">
                    <div class="menu-header">
                        <a class="logo" href="index.html">
                            <img src="assets/images/logo/logo.png" width="40%" alt="Personal Portfolio">
                        </a>
                        ...
                        <div class="order-2 order-lg-1 col-lg-9 col-xl-7">
                            <div class="content">
                                <div class="inner mb_sm--80">
                                    ...
                                    <h1 class="title" >Hi, I’m <span>shashikant website</span><br> <span
            ...
            <div class="row">
                <div class="col-xl-3 col-12 col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="logo-thumbnail">
                        <a href="#"><img src="assets/images/logo/logo.png" width="70%" alt="logo-image"></a>
                    </div>
